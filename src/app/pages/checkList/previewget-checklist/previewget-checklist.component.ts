...
@Component({
  selector: 'app-previewget-checklist',
  templateUrl: './previewget-checklist.component.html',
  styleUrls: ['./previewget-checklist.component.scss'],
})
export class PreviewgetChecklistComponent implements OnInit {
